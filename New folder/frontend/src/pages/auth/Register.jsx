...
/* Reuse same CSS string — in production, share via a shared auth.css or context */
const css = `
      ...
      <section className="au-panel">
        ...
        <div className="au-panel-copy">
          <h1 className="au-panel-title">
            Build your<br /><span>smart</span><br />agricultural<br />basket.
          </h1>
          <p className="au-panel-desc">
            Save addresses, apply coupons, place orders securely, and review delivered products.
          </p>
        </div>
